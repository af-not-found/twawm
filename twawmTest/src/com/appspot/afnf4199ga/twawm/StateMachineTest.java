...
public class StateMachineTest extends DexmakerInstrumentationTestCase {
	...
	public void testBattRateFast() {
		...
		long d;
		d = (long) (deltaTime * 0.94);
		sm.updateBattCalc(48, now + d, null);
		assertEquals(212, (int) (sm.currentRate * 10));
		assertEquals(150, (int) (sm.averageRate * 10));

		d = (long) (deltaTime * 0.95);
		sm.updateBattCalc(48, now + d, null);
		assertEquals(210, (int) (sm.currentRate * 10));
		assertEquals(150, (int) (sm.averageRate * 10));

		d = (long) (deltaTime * 0.96);
		sm.updateBattCalc(48, now + d, null);
		assertEquals(208, (int) (sm.currentRate * 10));
		assertEquals(164, (int) (sm.averageRate * 10));

		d = (long) (deltaTime * 0.97);
		sm.updateBattCalc(48, now + d, null);
		assertEquals(206, (int) (sm.currentRate * 10));
		assertEquals(164, (int) (sm.averageRate * 10));
	}
